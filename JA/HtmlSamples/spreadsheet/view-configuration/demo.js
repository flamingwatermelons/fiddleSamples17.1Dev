$(function () {
$.ig.loader({
			        scriptPath: "http://jp.dev.igniteui.local/17-1/js/",
			        cssPath: "http://jp.dev.igniteui.local/17-1/css/",
		...
		xhr.open('GET', 'http://jp.dev.igniteui.local/17-1/data-files/sample-data.xlsx', true);
		...
		xhr.onload = function (e) {
			...
			$.ig.excel.Workbook.load(responseArray, function () {
				...
				alert("Unable to download specified file.");
			})
		};
